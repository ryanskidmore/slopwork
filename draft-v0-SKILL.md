...
description: >
  ...
  Slopwork is the single source of truth for what to do, what's in progress, and
  what happened — never keep work state in markdown files or your own memory.
---

# Slopwork

Slopwork (`slop`) tracks work as a dependency graph of tickets. You read it to know what to do, you write to it as you work, and humans audit your trail (sessions, plans, progress, MRs, transcripts). Run `slop instructions` anytime for the project's local copy of these rules.
